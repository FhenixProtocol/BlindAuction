...
contract WrappingERC20 is ERC20, Permissioned {
    ...
    function _allowance(address owner, address spender) public view virtual returns (euint32) {
    ...
    function allowance(
        ...
        return FHE.sealoutput(_allowance(msg.sender, spender), permission.publicKey);
    }

    function approve(address spender, inEuint32 calldata value) public virtual returns (bool) {
